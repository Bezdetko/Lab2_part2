...
//Класс Document наследует класс File, т.е. дочерним и может обращаться ко всем членам и методам класса File со спецификаторами доступа public и protected.
    System.out.println("-".repeat(90));  
